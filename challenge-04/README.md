...
*/
carro.mudarCor = function (paramCor){
	carro.cor  = paramCor;
};
...
carro.addPessoas = function(qtdPassageiros){
	...
	((carro.quantidadePessoas + qtdPassageiros) > carro.assentos)){
		if ((carro.assentos - carro.quantidadePessoas) === 1){
			palavraPessoas = ' pessoa';
		}
		return 'Só cabem mais ' + (carro.assentos - carro.quantidadePessoas) + palavraPessoas + '!';
	}

	carro.quantidadePessoas = carro.quantidadePessoas + qtdPassageiros;
